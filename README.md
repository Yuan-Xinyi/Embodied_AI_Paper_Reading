...
- (2026.04 arXiv) [Grounded World Model for Semantically Generalizable Planning](https://arxiv.org/pdf/2604.11751)
  > ... each proposed action is scored based on how close its future outcome is to the task instruction, reflected by the similarity of embeddings.
...
- (2026.04 PI) [π0.7: a Steerable Generalist Robotic Foundation Model with Emergent Capabilities](https://arxiv.org/pdf/2604.15483)
  > ... strong out-of-the-box performance in a wide range of scenarios ...
...
### VLA & VLM
- (2026.04 arXiv) [HiVLA: A Visual-Grounded-Centric Hierarchical Embodied Manipulation System](https://arxiv.org/pdf/2604.14125)
  > ... explicitly decouples high-level semantic planning from low-level motor control ...
